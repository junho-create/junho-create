...
#   bash eval/presets/eval_20260409_vsgrpo_v6_nested.sh
...
OUT_ROOT="eval_results/$(date +%Y%m%d)/vsgrpo_v6_with_ocr_nested"
...
# USE_OCR="false"
# OUT_ROOT="eval_results/custom_vsgrpo_v6_with_ocr_nested"
# REPORT_IMAGE_MODE="embed"
# REPORT_SHARED_IMAGE_DIR="eval_results/shared_images/vsgrpo_v6_with_ocr_nested"
