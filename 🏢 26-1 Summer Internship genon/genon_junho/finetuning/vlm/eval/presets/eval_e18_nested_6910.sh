...
MODEL_GPU_MAP="400:0;500:1;600:2;700:3;800:4;final:6"
...
OUT_ROOT="eval_results/$(date +%Y%m%d)/e18_with_ocr_nested_6910"
...
bash eval/run_eval_checkpoints_tmux.sh \
  --exp_name e18_nested_6910 \
  --base_model_path /NHNHOME/WORKSPACE/0426030039_A/shkim/models/Qwen3.5-9B \
  --adapter_root /NHNHOME/WORKSPACE/0426030039_A/shkim/tsr_test/train/vlm/output/e18_qwen35_9b_6910 \
  --test_data /NHNHOME/WORKSPACE/0426030039_A/shkim/tsr_test/train/vlm/_train_data/20260406_nested_synthetic_200_2/data/test.jsonl \
  --max_samples 200 \
