...
MODEL_GPU_MAP="400:0;500:1;600:2;700:3;final:0"
...
OUT_ROOT="eval_results/$(date +%Y%m%d)/e17_with_ocr_nested_real"
...
bash eval/run_eval_checkpoints_tmux.sh \
  ...
  --test_data /home/vlm_train/qwen3_vl_tsr/_train_data/20260327_nested/data/valid.jsonl \
  --max_samples 200 \
