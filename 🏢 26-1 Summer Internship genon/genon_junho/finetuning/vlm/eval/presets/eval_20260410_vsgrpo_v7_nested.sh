...
OUT_ROOT="eval_results/$(date +%Y%m%d)/vsgrpo_v7_with_ocr_nested"
...
# USE_OCR="false"
# OUT_ROOT="eval_results/custom_vsgrpo_v7_with_ocr"
# REPORT_IMAGE_MODE="embed"
# REPORT_SHARED_IMAGE_DIR="eval_results/shared_images/vsgrpo_v7_with_ocr"

bash eval/run_eval_checkpoints_tmux.sh \
  --exp_name vsgrpo_v7 \
  --adapter_root /home/workspace/tsr_test/outputs/vsgrpo_v7 \
