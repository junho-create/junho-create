...
USE_OCR="false"
OUT_ROOT="eval_results/$(date +%Y%m%d)/e14_without_ocr"
...
# USE_OCR="false"
# OUT_ROOT="eval_results/custom_e15_without_ocr"
# REPORT_IMAGE_MODE="embed"
# REPORT_SHARED_IMAGE_DIR="eval_results/shared_images/e15_without_ocr"

bash eval/run_eval_checkpoints_tmux.sh \
  --exp_name e14 \
  --adapter_root /home/vlm_train/qwen3_vl_tsr/output/e14_qwen35_9b_6000/student_sft \
