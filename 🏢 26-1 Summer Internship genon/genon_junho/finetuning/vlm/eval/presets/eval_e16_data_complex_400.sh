...
USE_OCR="true"
OUT_ROOT="eval_results/$(date +%Y%m%d)/e16_20260327_data_complex_400_with_ocr"
...
bash eval/run_eval_checkpoints_tmux.sh \
  ...
  --test_data /home/vlm_train/qwen3_vl_tsr/_train_data/20260327_data_complex_400/data_merge/train.jsonl \
  --max_samples 716 \
  --batch_size 16 \
